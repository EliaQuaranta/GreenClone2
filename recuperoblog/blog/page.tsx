import ArticlesSlider from "../../src/app/_components/BlogComponents/ArticlesSlider";
import ArticlesGrid from "../../src/app/_components/BlogComponents/ArticlesGrid";
import MiddlePart from "../../src/app/_components/BlogComponents/CategoryButtons";
import SearchBar from "../../src/app/_components/BlogComponents/SearchBar";
import BlogHeader from "../../src/app/_components/BlogComponents/BlogHeader";
  ...
  return (
    <div className="blog">
      ...
      <div>
        ...
        <ArticlesGrid articles={gridArticles} category={undefined} />
      </div>
    </div>
  );
}
