...
return(
    ...
    <h1 className='text-center pt-20 font-extrabold text-3xl '>La Tua <h1 className='text-cyan-400'>Digital Performance</h1> Agency  </h1>
    ...
    <div className="flex w-full bg-[#F5F1EE] pt-10">
  <div className="grid w-1/3 h-20 flex-grow card rounded-box place-items-center">
    
    <h1 className='text-2xl font-bold'>Cosa</h1>
    <h3 className=' text-center'>Troviamo la strategia online più efficace per ogni business e la rendiamo scalabile.</h3>
  ...
  <div className="grid w-1/3 h-20 flex-grow card  rounded-box place-items-center">
    ...
    <h3 className=' text-center'>Formazione, aggiornamento ed esperienza sono nel nostro DNA.</h3>
  ...
  <div className="grid w-1/3 h-20 flex-grow card  rounded-box place-items-center">
    ...
    <h1 className='text-2xl font-bold'>Perchè</h1>
      ...
      <h3 className=' text-center'>Crediamo nella trasparenza,
